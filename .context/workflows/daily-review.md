...
> How AI should help the user plan his day.
...
1. **Overdue tasks** from your task manager
2. **Due today** items
...
**Could Do:**
4. Review inbox for captured tasks
...
- **Task manager:** Query task manager for overdue/due items
