...
- `correspondence/referee2/YYYY-MM-DD_round1_report.md` — Detailed written report
- `correspondence/referee2/YYYY-MM-DD_round1_deck.tex` — LaTeX source
- `correspondence/referee2/YYYY-MM-DD_round1_deck.pdf` — Compiled presentation
...
4. Referee 2 files Round 2 report at `correspondence/referee2/YYYY-MM-DD_round2_report.md`
...
You have a persistent Persistent Agent Memory directory at `$TASK_MGMT_DIR/.claude/agent-memory/referee2-reviewer/`. Its contents persist across conversations.
