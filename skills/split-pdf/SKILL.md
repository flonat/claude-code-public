...
2. If WebSearch doesn't yield a direct PDF link, try OpenAlex for open access URLs:
   ```python
   import sys
...
4. Save it to `./articles/` in the project directory (create the directory if needed)
5. Proceed to Step 2
